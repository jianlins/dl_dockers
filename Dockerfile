...
RUN pip install --no-cache-dir setuptools wheel jupyterlab Cython simpletransformers nltk bioc torchinfo imbalanced-learn \
    medspacy medspacy_io scikit-learn jupytext pandas tqdm tensorboard pytest\
